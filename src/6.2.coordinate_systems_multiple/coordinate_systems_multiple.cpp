//
// Created by mervin on 2019-02-15.
//
#include <glad/glad.h>
...
int main() {
    ...
    Shader aShader("6.2.coordinate_systems.vs", "6.2.coordinate_systems.fs");
    float vertices[] = {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        unsigned int modelLoc = glGetUniformLocation(aShader.ID, "model");
        unsigned int viewLoc = glGetUniformLocation(aShader.ID, "view");
